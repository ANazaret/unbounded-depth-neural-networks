...
from experiments.load_data import load_data_uci
...
from src.train import train_one_epoch_regression
...
if __name__ == "__main__":
    ...
    # LOAD DATA
    train_loader, valid_loader, test_loader, INPUT_SIZE = load_data_uci(
    ...
    # CREATE MODEL
    if DUN:
        generator_layers, generator_residual = make_generators_fcn_DUN(8, INPUT_SIZE, 1)
    else:
        generator_layers, generator_residual = make_generators_fcn(8, INPUT_SIZE, 1)
