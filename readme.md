...
The Unbounded Depth Neural network is implemented in PyTorch at [`src.models.UnboundedDepthNetwork`](blob/main/src/models.py).
...
## Training
Some helpful functions for training and evaluating the UDN are available in [`src/train.py`](blob/main/src/train.py).
